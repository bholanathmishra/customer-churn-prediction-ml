...
## Limitations
- The model performance is limited by the quality and noise in the dataset.
- Accuracy is moderate due to overlapping behavior patterns between churned and non-churned customers.
- The project focuses on interpretability and business relevance rather than maximizing accuracy.


## What I Learned
- Accuracy alone is not sufficient for churn prediction problems.
- Confusion matrix and recall are more important for business decisions.
- Feature importance helps translate ML output into actionable insights.
